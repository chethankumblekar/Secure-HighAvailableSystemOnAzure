...
| Operational Excellence | GitOps-ready module layout, ADRs (`docs/adr/`), per-alert runbooks (`docs/runbooks/`), self-service tenant onboarding via Backstage (`platform/backstage`) | — | Blameless postmortem template, DR drill log are Phase 9 |
